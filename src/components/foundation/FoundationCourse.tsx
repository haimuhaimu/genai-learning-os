...
import { GradientDescentExperiment, SoftmaxTemperatureExperiment } from '../course/ConceptExperiments'
...
export default function FoundationCourse({ initialNode, initialSection, go }: { initialNode?: string; initialSection?: string; go: Go }) {
  ...
  const hasInlineExperiment = node.id === 'softmax' || node.id === 'gradient-descent'
