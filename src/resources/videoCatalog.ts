...
export const videoResources = validateVideoCatalog([
  ...
  },
  {
    ...
    relatedCaseIds: ['rag-budget', 'context-window-budget', 'rag-chunking'], relatedRouteIds: ['llm'], level: '入门', casePriority: 10,
  ...
  },
  {
    ...
    relatedCaseIds: ['rag-budget', 'context-window-budget', 'rag-chunking'], relatedRouteIds: ['llm'], level: '进阶', casePriority: 30,
  ...
  },
  {
    ...
    relatedCaseIds: ['rag-budget', 'context-window-budget', 'rag-chunking'], relatedRouteIds: ['llm'], level: '进阶', casePriority: 50,
  ...
  },
  {
    ...
    relatedCaseIds: ['rag-budget', 'context-window-budget', 'rag-chunking'], relatedRouteIds: ['llm'], level: '入门', casePriority: 15,
  ...
  },
  {
    ...
    relatedCaseIds: ['rag-budget', 'context-window-budget', 'rag-chunking'], relatedRouteIds: ['llm'], level: '进阶', casePriority: 40,
  ...
  },
  {
    ...
    relatedCaseIds: ['rag-budget', 'context-window-budget', 'rag-chunking'], relatedRouteIds: ['llm'], level: '进阶', casePriority: 20,
