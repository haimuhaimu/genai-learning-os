...
import { ActivationExperiment, CrossEntropyExperiment, GradientDescentExperiment, MlpWidthExperiment, MoeRoutingExperiment, SoftmaxTemperatureExperiment } from '../course/ConceptExperiments'
...
export default function FoundationCourse({ initialNode, initialSection, go }: { initialNode?: string; initialSection?: string; go: Go }) {
  ...
  const hasInlineExperiment = ['softmax', 'cross-entropy', 'gradient-descent', 'activation', 'mlp', 'moe'].includes(node.id)
