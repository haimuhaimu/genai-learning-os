...
const readingPaths: Array<{ title: string; description: string; paperIds: string[]; area: PaperArea }> = [
  { title: '从 Transformer 到低成本服务', description: '架构 → 混合专家 → 蒸馏 → 对齐 → 注意力 IO → 解码 → KV cache', paperIds: ['attention-is-all-you-need', 'switch-transformers', 'distilling-the-knowledge-in-a-neural-network', 'instructgpt', 'flashattention', 'speculative-decoding', 'pagedattention-vllm'], area: 'Transformer / LLM' },
